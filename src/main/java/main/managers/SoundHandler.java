...
public class SoundHandler {
     ...
     public static String CONNECTED = "src/main/java/main/sounds/connected.wav";
     public static String MESSAGE_IN_OPENED_TAB = "src/main/java/main/sounds/chat_message_in_current_tab.wav";
